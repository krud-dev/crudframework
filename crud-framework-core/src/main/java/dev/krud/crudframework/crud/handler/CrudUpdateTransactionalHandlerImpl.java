...
public class CrudUpdateTransactionalHandlerImpl implements CrudUpdateTransactionalHandler {
    ...
    public <ID extends Serializable, Entity extends BaseCrudEntity<ID>> Entity updateTransactional(Entity entity, DynamicModelFilter filter, List<CRUDOnUpdateHook<ID, Entity>> onHooks, List<AbstractChangeHook> fieldChangeHooks, boolean applyPolicies) {
    ...
    @Override
    @Transactional(readOnly = false)
    public <ID extends Serializable, Entity extends BaseCrudEntity<ID>> Entity updateFromTransactional(DynamicModelFilter filter, Object object, Class<Entity> clazz, List<CRUDOnUpdateFromHook<ID, Entity>> onHooks, List<AbstractChangeHook> fieldChangeHooks, boolean applyPolicies) {
    ...
    @Override
    @Transactional(readOnly = false)
    public <ID extends Serializable, Entity extends BaseCrudEntity<ID>> List<Entity> bulkUpdateTransactional(List<Entity> entities, DynamicModelFilter filter, List<CRUDOnUpdateHook<ID, Entity>> onHooks, List<AbstractChangeHook> fieldChangeHooks, boolean applyPolicies) {
        if (entities.isEmpty()) {
